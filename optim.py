...
def momentum_sgd(loss,hyper_params,params):
    ...
    for param_i,update_i in updates:
        ...
        new_updates[velocity_i]=x - param_i
        new_updates[param_i]=x
    return new_updates.items()
...
def ada_grad(loss,hyper_params,params):
    ...
    for param_i,diff_i in zip(params,diff):
        ...
        new_updates[accu_i]=next_accu_i
        new_updates[param_i]=param_i - learning_rate * (diff_i /T.sqrt(next_accu_i))
    return new_updates.items()